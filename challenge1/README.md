...
Input files created:
  - challenge1/examples/input1.txt
  - challenge1/examples/input2.txt

Output files will be written to:
  - challenge1/examples/output1.txt
  - challenge1/examples/output2.txt

============================================================
Starting producer-consumer processing...
============================================================

[Producer-1] Produced: apple
[Consumer-1] Consumed and processed: apple -> APPLE
[Producer-1] Produced: banana
[Consumer-2] Consumed and processed: banana -> BANANA
[Producer-2] Produced: fig
[Consumer-1] Consumed and processed: fig -> FIG
...
